...
public class MatchService {
    ...
    public Match createMatch(Match match) {
        Team team1 = teamRepository.findById(match.getTeam1().getTeamId())
                .orElseThrow(() -> new TeamNotFoundException("Team not found with id: " + match.getTeam1().getTeamId()));
        Team team2 = teamRepository.findById(match.getTeam2().getTeamId())
                .orElseThrow(() -> new TeamNotFoundException("Team not found with id: " + match.getTeam2().getTeamId()));

        Match cricketMatch = new Match(match.getOvers(), team1, team2,null);
